...
//				}
			...
			SPI_CS1_RESET;uSec(50);
			SPI1_CR1 |= SPI_CR1_SPE;// enable SPI	
			msgCPU1_CCC0[0]=SPI_SendRecv('?');
			msgCPU1_CCC0[1]=SPI_SendRecv('B');
			msgCPU1_CCC0[2]=SPI_SendRecv('P');
			msgCPU1_CCC0[3]=SPI_SendRecv('N');
			msgCPU1_CCC0[4]=SPI_SendRecv('1');
				SPI_CS1_SET;uSec(50);
			SPI1_CR1 &= ~SPI_CR1_SPE;// disable SPI	
			LCD_MSG[13]=msgCPU1_CCC0[0];
			...
			SPI1_CR1 |= SPI_CR1_SPE;// enable SPI	
			//msgCPU2_CCC0[0]='f';	
			msgCPU2_CCC0[0]=SPI_SendRecv('?');//mSec(20);
