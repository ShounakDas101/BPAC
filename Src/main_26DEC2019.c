...
I2C_Init();	
	...
	switch(boardName){
      ...
      mSec(5000);
			...
			SPI1_CR1 |= SPI_CR1_SPE;// enable SPI	
			//msgCPU2_CCC0[0]='f';	
			msgCPU2_CCC0[0] = SPI_SendRecv('2');//mSec(20);
			//msgCPU1_CCC0[1]=SPI_SendRecv('2');
			SPI_CS2_SET;uSec(50);	
			SPI1_CR1 &= ~SPI_CR1_SPE;// disable SPI	
			...
			SPI1_CR1 |= SPI_CR1_SPE;// enable SPI	
			msgCPU3_CCC0[0] = SPI_SendRecv('3');//mSec(20);
			SPI_CS3_SET;uSec(50);
			SPI1_CR1 &= ~SPI_CR1_SPE;// disable SPI
			LCD_MSG[15]=msgCPU3_CCC0[0];
