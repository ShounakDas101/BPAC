...
/*		INPUT RELAYS  */
#define POWER_FRONT_STATUS	GPIOE_IDR & 0x0040 //PE6  shifted to bit 1>>5
#define TGTXR_FRONT_STATUS	GPIOE_IDR & 0x0080 //PE7  shifted to bit 0>>7
#define CANCO_FRONT_STATUS 	GPIOE_IDR & 0x0008 //PE3  shifted to bit 3>>0
#define TCFR_FRONT_STATUS 	GPIOE_IDR & 0x0010 //PE4  shifted to bit 2>>2
#define ASGNCR_FRONT_STATUS GPIOE_IDR & 0x0001 //PE0  shifted to bit 5<<5
#define HSGNCR_FRONT_STATUS GPIOE_IDR & 0x0002 //PE1  shifted to bit 4<<3
#define BPNR_FRONT_STATUS 	GPIOF_IDR & 0x2000 //PF13 shifted to bit 7>>6
#define BIPR1_FRONT_STATUS 	GPIOF_IDR & 0x4000 //PF14 shifted to bit 6>>8

#define POWER_BACK_STATUS 	GPIOF_IDR & 0x0400 //PF10 shifted to bit 1>>9
#define TGTXR_BACK_STATUS 	GPIOF_IDR & 0x0800 //PF11 shifted to bit 0>>11
#define CANCO_BACK_STATUS   GPIOC_IDR & 0x0008 //PC3  shifted to bit 3<<3
#define TCFR_BACK_STATUS 	  GPIOF_IDR & 0x0100 //PF8  shifted to bit 2>>6
#define ASGNCR_BACK_STATUS 	GPIOC_IDR & 0x0001 //PC0  shifted to bit 5<<2
#define HSGNCR_BACK_STATUS 	GPIOC_IDR & 0x0002 //PC1  shifted to bit 4<<2
#define BPNR_BACK_STATUS 	  GPIOC_IDR & 0x0040 //PC6  shifted to bit 7<<1
#define BIPR1_BACK_STATUS 	GPIOC_IDR & 0x0020 //PC5  shifted to bit 6<<1

/*		FEEDBACK RELAYS       */
#define LFR_FRONT_STATUS 		GPIOE_IDR & 0x4000 //PE14 shifted to bit 1 >>13
#define TCFXR_FRONT_STATUS 	GPIOE_IDR & 0x8000 //PE15 shifted to bit 0 >>15
#define TCFCR_FRONT_STATUS 	GPIOE_IDR & 0x0800 //PE11 shifted to bit 3 >>8
#define TGTYR_FRONT_STATUS 	GPIOE_IDR & 0x1000 //PE12 shifted to bit 2 >>10
#define ASGNCPR_FRONT_STATUS 	GPIOE_IDR & 0x0100 //PE8  shifted to bit 5 >>3
#define TGTZR_FRONT_STATUS 	GPIOE_IDR & 0x0200//PE9 shifted to bit 4 >>5
#define BLR_FRONT_STATUS 		GPIOG_IDR & 0x0400 //PG10 shifted to bit 7 >>3
#define BIPR2_FRONT_STATUS 	GPIOG_IDR & 0x0200 //PG9  shifted to bit 6 >>3

#define LFR_BACK_STATUS 		GPIOG_IDR & 0x2000 //PG13 shifted to bit 1 >>12
#define TCFXR_BACK_STATUS   GPIOG_IDR & 0x1000 //PG12 shifted to bit 0 >>12
#define TCFCR_BACK_STATUS 	GPIOB_IDR & 0x0100 //PB8  shifted to bit 3 >>5
#define TGTYR_BACK_STATUS 	GPIOG_IDR & 0x8000 //PG15 shifted to bit 2 >>13
#define ASGNCPR_BACK_STATUS GPIOB_IDR & 0x0800 //PB11 shifted to bit 5 >>6
#define TGTZR_BACK_STATUS 	GPIOB_IDR & 0x0400 //PB10 shifted to bit 4 >>6
#define BLR_BACK_STATUS 	  GPIOB_IDR & 0x4000 //PB14 shifted to bit 7 >>7
#define BIPR2_BACK_STATUS 	GPIOB_IDR & 0x2000 //PB13 shifted to bit 6 >>7
