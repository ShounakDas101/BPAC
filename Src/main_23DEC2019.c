...
I2C_Init();	
	...
	switch(boardName){
      ...
      mSec(5000);
			...
			msgCPU1_CCC0 = SPI_SendRecv('1');//mSec(20);
			SPI_CS1_SET;uSec(50);		
			LCD_MSG[13]=msgCPU1_CCC0;
				
			SPI_CS2_RESET;uSec(50);
			msgCPU2_CCC0 = SPI_SendRecv('2');//mSec(20);
			SPI_CS2_SET;uSec(50);	
			LCD_MSG[14]=msgCPU2_CCC0;
				
			SPI_CS3_RESET;uSec(50);
			msgCPU3_CCC0 = SPI_SendRecv('3');//mSec(20);
			SPI_CS3_SET;uSec(50);
			LCD_MSG[15]=msgCPU3_CCC0;
      ...
      while(1);
		...
		case 1:{
			...
			while(1){
				...
				msgCCC0_CPU1=SPI_SendRecv('A');
				rs_CPU1=SPI_CS1_STATUS;
				if(rs_CPU1){
			    TCFCR_SET;
          TCFXR_RESET;LFR_SET;}				
				else{
		...
		case 3:{
			...
			while(1){
				rs_CPU3=SPI_CS3_STATUS;
				if(rs_CPU3){
					TCFCR_SET;//LCD_Send_string_Line2(CPU2_ready);
				  TCFXR_RESET;LFR_SET;}
				else{
					TCFCR_RESET;
				  TCFXR_SET;LFR_RESET;
				  msgCCC0_CPU3=SPI_SendRecv('C');
				  }
			}
		}
